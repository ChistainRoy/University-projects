            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link active" href="javascript:void(0)" id="navbarDropdown" role="button"
    ...
    if (isset($_SESSION['username_user'])) {
        ...
        <div class="card col-xl-6">
            <div class="row px-5">
                ...
                <div class="col-xl-6">
                    <h2>ที่อยู่จัดส่ง<button class="btn btn-primary float-end" type="button" class="btn btn-primary"
                            data-bs-toggle="modal" data-bs-target="#editaddressModal">แก้ไข</button>
                    </h2>
                    <hr>
                        ...
                        <div class="col-xl-3 col-lg-6 mt-3 text-center">
                            ...
                            <form method="POST" action="submit-form.php">
                                <button type="button" class="btn rounded-pill btn-icon btn-primary"
                                    onclick="increment('<?php echo $inputId; ?>')">
                                    <span class="bx bxs-plus-circle fs-3"></span>
                                </button>

                                <input type="number" value="1" class="inputnumber w-25 text-center mx-2"
                                    id="<?php echo $inputId; ?>" oninput="calculateResult()" name="values[]">
                                <button type="button" class="btn rounded-pill btn-icon btn-primary"
                                    onclick="decrement('<?php echo $inputId; ?>')">
                                    <span class="bx bx-minus-circle fs-3"></span>
                                </button>
                                <input type="hidden" value="<?php echo $yourComparisonID ?>"
                                    class="from-control w-25 d-inline text-center mx-2 input-group-text"
                                    name="productid[]">
                        </div>
                            ...
                            <form action="cartproduct.php" method="post">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <textarea id="basic-icon-default-message" class="form-control"
                                        placeholder="<?php echo $address ?>" aria-label="address"
