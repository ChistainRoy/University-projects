...
>
  ...
  <body>
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="boss_db.php" method="POST">
                <div class="mb-3">
    ...
    <?php if (isset($_SESSION['success_boss'])) : ?>
        <script>
           Swal.fire({
        icon: 'success',
        title: 'สำเร็จ',
        text: '<?php echo $_SESSION['success_boss']; ?>',
    }).then((result) => {
        if (result.isConfirmed) {
            window.location.href = 'index_boss.php'; // เปลี่ยนเป็น URL ที่ต้องการให้ไป
        }
    });
        </script>
    <?php unset($_SESSION['success_boss']);
    endif; ?>
      <?php if (isset($_SESSION['errors_boss'])) : ?>
        <script>
            Swal.fire({
                icon: 'error',
                title: 'เกิดข้อผิดพลาด',
                text: '<?php echo $_SESSION['errors_boss']; ?>',
            });
        </script>
    <?php unset($_SESSION['errors_boss']);
        endif; ?>
  </body>
</html>