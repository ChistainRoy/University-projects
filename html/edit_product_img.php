        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
           ...
           <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">รายการสินค้าทั้งหมด /</span> แก้ไขรูปภาพ ID <?php echo $product_id ?></h4>
              <!-- Examples -->
              <div class="card">
              ...
              <input type="hidden" name="old_photo_path" value="<?php echo $img ?>">
                    ...
                    <div class="modal-footer">
                        <input type="submit" name="editimg" value="แก้ไขรูปภาพ" class="btn btn-primary">
                    </div>
                </form>
                </div>
