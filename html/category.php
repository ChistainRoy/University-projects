        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              include 'modal.php';
              ?>
                <h5 class="card-header">ตารางข้อมูลประเภทสินค้า</h5>
                ...
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    ?>
                                            <tr>
                                                <td><i class="fab fa-angular fa-lg text-danger me-3"></i><?php echo $fetch['id_cat'] ?></td>
                                                <td><?php echo $fetch['cat_name'] ?></td>
                                                <td> 
                                                <button type="button" 
                                                        class="btn rounded-pill btn-icon btn-primary"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#editcat<?php echo $fetch['id_cat'] ?>">
                                                ...
                                                <button type="button" 
                                                        ...
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#catdel<?php echo $fetch['id_cat'] ?>">
