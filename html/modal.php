...
<!-- Modal del cat -->
<div class="modal fade" id="catdel<?php echo $fetch['id_cat'] ?>" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            ...
            <div class="modal-body">
                <form action="cat_edit.php" method="get">
                    <div class="row g-2">
                        <div class="col mt-3">
                            <label for="nameBasic" class="form-label">
                                <h4>ต้องการลบ ID <?php echo $fetch['id_cat'] ?> หรือไม่</h4>
                            </label>
                            <input type="text" id="nameBasic" class="form-control d-none" name="id" value="<?php echo $fetch['id_cat'] ?>" required readonly />
                        </div>
                    </div>
            </div>
            <div class="modal-footer">
