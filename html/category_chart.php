...
$monthlySalesData = array_fill(0, 5, 0); // Initialize an array to store monthly sales data with 12 zeros
$totalSum = 0;
if ($query) {
    while ($row = mysqli_fetch_assoc($query)) {
        ...
        // กำหนดค่าจำนวนสินค้าที่ขายได้ในอาร์เรย์ตามประเภท
        if ($cat_name === 'หน้าต่างบานเลื่อน') {
            $monthlySalesData[0] += $oder_qty;
        } elseif ($cat_name === 'หน้าต่างบานพับ') {
            $monthlySalesData[1] += $oder_qty;
        } elseif ($cat_name === 'หน้าต่างห้องน้ำ') {
            $monthlySalesData[2] += $oder_qty;
        } elseif ($cat_name === 'ประตูบานเลื่อน') {
            $monthlySalesData[3] += $oder_qty;
        } elseif ($cat_name === 'ประตูบานพับ') {
            $monthlySalesData[4] += $oder_qty;
        }
        $totalSum += $oder_qty; // นับรวมยอดขายทั้งหมด
    }
} else {
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row mb-5">
                <div class="col-md-6 col-lg-7 mb-3">
                  ...
                  <div class="row">
                    <div class="card-body col-xl-6 col-divider">
                      ...
                      <p class="card-text">
                        จำนวนสิ้นค้าทุกประเภทที่ขายไปทั้งหมด
                      </p>
                    </div>
                ...
                <h5 class="card-header">กราฟแสดงรายแต่ละประเภทสินค้า</h5>
                <canvas id="barChart" width="450" height="100"></canvas>
...
<script>
    ...
    var chartConfig = {
        type: 'bar',
        data: {
            labels: ['หน้าต่างบานเลื่อน', 'หน้าต่างบานพับ', 'หน้าต่างห้องน้ำ', 'ประตูบานเลื่อน', 'ประตูบานพับ'],
            datasets: [{
                label: 'ประเภทสินค้าที่ขายได้ (ชิ้น)',
