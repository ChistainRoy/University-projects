        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
           ...
           <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">รายการสินค้าทั้งหมด /</span> แก้ไขรายการสินค้า ID <?php echo $product_id ?></h4>
              <!-- Examples -->
              <div class="card">
              <div class="add demo-inline-spacing">
              <form action="product_edit.php" method="post" enctype="multipart/form-data">
              <input type="text" id="productname" class="form-control d-none" name="productid" required value="<?php echo $product_id ?>" />
              <img src="<?php echo $img ?>" class="mx-auto d-block mt-1" width="200" name="longimg">
              <input type="hidden" name="old_photo_path" value="<?php echo $img ?>">
            
                    <div class="mb-3">
                        <label for="productname" class="form-label">ชื่อสินค้า</label>
                        <input type="text" id="productname" class="form-control" name="productname" required value="<?php echo $name ?>" />
                    </div>
                    <div class="mb-3">
                        <label for="price" class="form-label">ราคาสินค้า</label>
                        <input type="number" id="price" class="form-control" name="price" required value="<?php echo $price ?>"/>
                    </div>

                    <div class="row g-2">
                        <div class="col mb-0">
                            <label for="width" class="form-label">ความกว้าง</label>
                            <input type="number" id="width" class="form-control" name="width" value="<?php echo $width ?>" required />
                        </div>

                        <div class="col mb-3">
                            <label for="length" class="form-label">ความยาว</label>
                            <input type="number" id="length" class="form-control" name="length" value="<?php echo $length ?>" required />
                        </div>
                    </div>
                    <div class="row g-2">
                        <div class="col mb-0">
                            ...
                            <select class="form-select" id="exampleFormControlSelect1" aria-label="Default select example" name="color">
                                <option>เลือกสีกระจก</option>
                                <option value="1"<?php if ($colorglass == "1") {
                                                    echo "selected";
                                                  } ?>>สีเขียว </option>
                                <option value="2"<?php if ($colorglass == "2") {
                                                    echo "selected";
                                                  } ?>>สีดำ </option>
                                <option value="3" <?php if ($colorglass == "3") {
                                                    echo "selected";
                                                  } ?>>สีกันยูวี</option>
                            </select>
                        </div>
                    ...
                    <div class="modal-footer">
                        <input type="submit" name="editcart" value="แก้ไข" class="btn btn-primary">
                    </div>
                </form>
                </div>
